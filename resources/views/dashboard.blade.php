                        ...
                        <div class="card">
                            <div class="card-body px-3 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h6 class="text-muted font-semibold">Notifications</h6>
                                        <h6 class="font-extrabold mb-0">{{ $sesion }}</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-header">
                                <h4>ORT Issues Status</h4>
                            </div>
                            <div class="card-body">
                                <canvas id="ortissuesChart1" style="height: 153px; display: block; width: 306px;" width="306"
...
@section('scripts')
    ...
    <script>
        ...
        var y=JSON.parse('{!! json_encode($issues) !!}');
        var x=JSON.parse('{!! json_encode($directorate) !!}');
    </script>
    <script>
        new Chart(document.getElementById("issues-chart"), {
  type: 'bar',
  data: {
    labels: x,
    datasets: [{ 
    ...
    <script>
       ...
       var ortissuesChart1Data = {
        ...
        window.onload = function() {
           // var ortissuesChart1 = document.getElementById("ortissuesChart1").getContext("2d");
         ...
         /*   window.myBar = new Chart(ortissuesChart1, {
                type: 'bar',
                data: ortissuesChart1Data,
                options: {
                    elements: {
                        rectangle: {
                            borderWidth: 1,
                    ...
                    title: {
                        display: true,
                        text: 'Green: Done, Red: Not Done, Amber: Pending'
                    },
                    legend: {
                        display: false
                    },
