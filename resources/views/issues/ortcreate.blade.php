                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('newissue') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="issue_type" type="text" class="form-control @error('name') is-invalid @enderror" name="issue_type" value="ORT" required autocomplete="name" readonly>
                        ...
                        <div class="form-group row">
                            <label for="programme" class="col-md-4 col-form-label text-md-right"> Select Programme </label>

                            <div class="col-md-6">
                                <select class=" form-control " name="programme" id="programme" required autofocus>
                                        
                                    
                                    <option value="Basic Education">Basic Education</option>
                                    <option value="Secondary Education">Secondary Education</option>
                                    <option value="Higher Education">Higher Education</option>
                                    <option value="Management and Support Services">Management and Support Services</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="budget" type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))" class="form-control @error('name') is-invalid @enderror" name="budget" value="{{ old('budget') }}" required autocomplete="name">
