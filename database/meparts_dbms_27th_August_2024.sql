...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2024 at 09:55 AM
...
CREATE TABLE `directorates` (
  ...
  `dir_name` varchar(191) NOT NULL,
  `dir_name_short` varchar(191) NOT NULL,
  `hod_name` varchar(191) NOT NULL,
  `hod_sex` varchar(191) NOT NULL,
...
CREATE TABLE `issues` (
  ...
  `date_assigned` varchar(191) NOT NULL,
  `date_due` varchar(191) NOT NULL,
  `status` varchar(191) NOT NULL,
  `reason` varchar(255) DEFAULT NULL,
  `se_input` varchar(255) DEFAULT NULL,
  `dir_responce` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `management_direction_orts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ort_activity_id` varchar(191) NOT NULL,
...
CREATE TABLE `management_direction_projects` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `project_activity_id` varchar(191) NOT NULL,
  `direction` varchar(191) DEFAULT NULL,
  `date` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `meetings` (
  ...
  `order_paper` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orderpapers` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `orderpaper` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `programmes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `programme_name` varchar(191) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `project_issues` (
  ...
  `activity` varchar(191) NOT NULL,
  `directorate_id` varchar(191) NOT NULL,
  `fin_year` varchar(7) DEFAULT NULL,
  `date_due` varchar(191) NOT NULL,
  `status` varchar(191) NOT NULL,
  `budget` varchar(191) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
('2iYP3f4mmuHuYcpBOv9hyFBhTYM6XUWf0juL45YZ', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', '', 1724741527),
('H1DAPCdV2UWB7CET5nJUEDUGPoEYEmtedi57LX1D', 70, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36', '', 1724745218);
...
CREATE TABLE `users` (
  ...
  `role` varchar(10) NOT NULL COMMENT 'WILL BE GETTING SHORT NAME OF DIRECTORATE',
...
(70, 'moe', 'dev', 'moedev@education.gov.mw', 0, 'ICT', NULL, NULL, '$2y$10$jXsDuycn3/1a9nXBMAOmXuQXAUoOHZyvp6uYKgTJx.MxQsVtHdrJm', NULL, NULL, NULL, NULL, NULL, '2024-08-27 07:32:59', '2024-08-27 07:32:59');
...
--
-- Indexes for table `management_direction_orts`
--
ALTER TABLE `management_direction_orts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `management_direction_projects`
--
ALTER TABLE `management_direction_projects`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `ort_issues`
--
ALTER TABLE `ort_issues`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fin_yearO` (`fin_year`);
...
--
-- AUTO_INCREMENT for table `management_direction_orts`
--
ALTER TABLE `management_direction_orts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `management_direction_projects`
--
ALTER TABLE `management_direction_projects`
...
--
-- AUTO_INCREMENT for table `ort_issues`
--
ALTER TABLE `ort_issues`
